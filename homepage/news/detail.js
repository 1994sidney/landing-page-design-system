(() => {
  const articles = {
    ...
    'community-mental-health-service-practice': {
      meta: '项目实践 · 2026年5月',
      title: '心理健康服务如何进入基层社区与公共服务场景',
      lead: '从服务组织、资源连接与持续运营三个方面，梳理基层心理服务从活动走向常态化支持的实践路径。',
      body: [
        '基层心理健康服务的重点，不只是增加一次性的活动数量，而是让居民能够在社区公共服务体系中持续获得科普、关爱、咨询转介和必要的专业支持。',
        '平台通过连接专业人员、服务机构和基层公共服务场景，逐步形成可持续组织、可追踪实施、可衔接转介的服务机制，使心理健康服务更稳定地进入居民日常生活。'
      ]
    }
  };
